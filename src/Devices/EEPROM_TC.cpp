...
uint32_t EEPROM_TC::getArbitraryPhOriginTime() {
  return eepromReadInt(ARBITRARY_PH_ORIGIN_TIME_ADDRESS);
}
...
void EEPROM_TC::setArbitraryPhOriginTime(uint32_t value) {
  eepromWriteInt(ARBITRARY_PH_ORIGIN_TIME_ADDRESS, value);
}
