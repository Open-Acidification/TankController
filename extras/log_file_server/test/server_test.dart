...
void main() {
  ...
  test('Get snapshot from /api/snapshotTest.log', () async {
    ...
    final logTable = const CsvToListConverter(
      fieldDelimiter: '\t',
      eol: '\n',
  ...
  test('trimToTimeRange trims normal list', () async {
    ...
    final newList = trimToTimeRange(
      testList,
      5,
      DateTime.parse('2023-10-01 00:10:00'),
    );
  ...
  test(
    'trimToTimeRange returns empty list when last data is too old',
    () async {
      final testList = [
        ['v0', 0, 'I', '2023-10-01 00:00:00'],
        ['v0', 0, 'I', '2023-10-01 00:01:00'],
      ...
      final newList = trimToTimeRange(
        testList,
        5,
        DateTime.parse('2023-10-01 00:20:00'),
      );
