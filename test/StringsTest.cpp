...
unittest(stringCopy) {
  ...
  assertEqual("WARNING! String \"stringtest\" was truncated to \"stringte\"", Serial_TC::instance()->getBuffer());

  Serial_TC::instance()->clearBuffer();  // the history of data written
  assertEqual(1, strscpy(dest2, source, sizeof(dest2)));
  assertEqual("stringtes", dest2);
  assertEqual('\0', dest2[9]);
  assertEqual("WARNING! String \"stringtest\" was truncated to \"stringtes\"", Serial_TC::instance()->getBuffer());
  ...
  assertEqual("", Serial_TC::instance()->getBuffer());
}
...
unittest(stringCopy_P) {
  ...
  assertEqual("stringte", dest1);
  assertEqual('\0', dest1[8]);
  assertEqual("WARNING! String (P) \"stringtest\" was truncated to \"stringte\"", Serial_TC::instance()->getBuffer());

  Serial_TC::instance()->clearBuffer();  // the history of data written
  assertEqual(1, strscpy_P(dest2, source, sizeof(dest2)));
  assertEqual("stringtes", dest2);
  assertEqual('\0', dest2[9]);
  assertEqual("WARNING! String (P) \"stringtest\" was truncated to \"stringtes\"", Serial_TC::instance()->getBuffer());
...
unittest(floatToString) {
  ...
  assertEqual("WARNING! String \"-1000.44\" was truncated to \"-1000.\"", Serial_TC::instance()->getBuffer());
  ...
  assertEqual("WARNING! String \"1.30000\" was truncated to \"1.3000\"", Serial_TC::instance()->getBuffer());
  ...
  assertEqual("WARNING! String \"10000000000000.0\" was truncated to \"100000\"", Serial_TC::instance()->getBuffer());
}
unittest(strtofloat) {
