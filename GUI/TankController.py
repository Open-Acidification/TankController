...
class TankController(wx.Frame):
    ...
    def layoutMain(self):
        ...
        sizer.Add(
            self.layoutTop(), flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border
        )
        sizer.Add(
            self.layoutBottom(), flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border
        )
    ...
    def layoutTop(self):
        ...
        sizer.Add(
            self.layoutEEPROM(), flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border
        )
        return sizer
    ...
    def layoutTopLeft(self):
        sizer = wx.BoxSizer(wx.VERTICAL)
        sizer.Add(
            self.layoutDevice(), flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border
        )
        sizer.Add(
            self.layoutTank(), flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border
        )
        sizer.Add(
            self.layoutSerial1(),
            flag=wx.EXPAND | wx.LEFT | wx.RIGHT,
    ...
    def layoutTank(self):
        sizer = wx.BoxSizer(wx.HORIZONTAL)
        sizer.Add(
            self.layoutTemp(), flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border
        )
        sizer.Add(
            self.layoutPH(), flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border
        )
        button = wx.Button(self.panel, -1, "Send")
        button.Bind(wx.EVT_BUTTON, self.sendFromPH)
        sizer.Add(button, flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border)
        return sizer

    def layoutTemp(self):
        sizer = wx.StaticBoxSizer(wx.VERTICAL, self.panel, label="Temperature Probe")
        temp = wx.TextCtrl(
            self.panel,
            value="12.345",
            style=wx.TE_RIGHT,
        ...
        temp.SetFont(font)
        sizer.Add(temp, flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border)
        return sizer

    def layoutPH(self):
        sizer = wx.StaticBoxSizer(wx.VERTICAL, self.panel, label="From pH Probe")
    ...
    def layoutDevice(self):
        ...
        sizer.Add(
            self.layoutKeypad(), flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border
        )
        return sizer
    ...
    def layoutDisplay(self):
        sizer = wx.BoxSizer(wx.HORIZONTAL)
        sizer.Add(
            self.layoutLQD(), flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border
        )
        sizer.Add(
            self.layoutPins(), flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border
        )
        return sizer

    def layoutLQD(self):
        sizer = wx.StaticBoxSizer(wx.VERTICAL, self.panel)
        self.lqd = wx.StaticText(self.panel, label=libTC.lcd(0) + "\n" + libTC.lcd(1))
        font = wx.Font(
            22, wx.FONTFAMILY_TELETYPE, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL
        )
        self.lqd.SetFont(font)
        sizer.Add(self.lqd, flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border)
        return sizer

    def layoutPins(self):
        sizer = wx.StaticBoxSizer(wx.VERTICAL, self.panel)
        self.pins = wx.StaticText(self.panel, label="LED:  OFF\nHEAT: OFF\nCO2:  OFF")
        font = wx.Font(
            15, wx.FONTFAMILY_TELETYPE, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL
        )
        self.pins.SetFont(font)
        sizer.Add(self.pins, flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border)
        return sizer
    ...
    def layoutKeypad(self):
        ...
        for each in labels:
            button = wx.Button(
                self.panel, label=each, size=self.FromDIP(wx.Size(76, 25))
            )
            button.Bind(wx.EVT_LEFT_UP, self.KeypadEvent)
            keypadGrid.Add(button, 1, flag=wx.EXPAND)
        sizer.Add(keypadGrid, flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border)
        return sizer
    ...
    def layoutEEPROM(self):
        ...
        sizer = wx.StaticBoxSizer(wx.HORIZONTAL, self.panel, label="EEPROM")
        ...
        for i, each in enumerate(labels):
            ...
            value = wx.StaticText(self.panel, size=self.FromDIP(wx.Size(100, 16)))
            box.Add(
                value,
        ...
        sizer.Add(leftSizer, flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border)
        sizer.Add(centerSizer, flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border)
        sizer.Add(rightSizer, flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border)
        return sizer
    ...
    def layoutSerial0(self):
        ...
        self.serial0 = wx.TextCtrl(
            self.panel,
            size=self.FromDIP(wx.Size(800, 200)),
            style=wx.TE_READONLY | wx.TE_MULTILINE | wx.HSCROLL,
        )
        sizer.Add(self.serial0, flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border)
        return sizer
    ...
    def layoutSerial1(self):
        sizer = wx.StaticBoxSizer(
            wx.VERTICAL,
            self.panel,
            label="Commands from TankController to pH probe on serial port 1",
        )
        self.serial1 = wx.TextCtrl(
            self.panel,
            size=self.FromDIP(wx.Size(300, 100)),
            style=wx.TE_READONLY | wx.TE_MULTILINE | wx.HSCROLL,
        )
        sizer.Add(self.serial1, flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=self.border)
        return sizer
