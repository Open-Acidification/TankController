...
void main() {
  ...
  test_package.test('Constructors', () {
    final CsvReaderForApp newCsvReaderAppWeb = CsvReaderForApp('test1.csv');
    final CsvReaderLocal newCsvReaderAppLocal = CsvReaderLocal('test2.csv');

    expect(newCsvReaderAppWeb.filePath, equals('test1.csv'));
    expect(newCsvReaderAppLocal.filePath, equals('test2.csv'));
  });
...
01/20/2023 16:18:25,  99, 4.56, 10.00, 4.123, 8.645,   11,    740.0,    140.0,      4.0''',
  ...
  // test_package.test('fetchCsvData with app class', () async {
