...
unittest(test) {
  ...
  assertEqual(TemperatureControl::instance()->tempSetTypeTypes::FLAT_TYPE, TemperatureControl::instance()->getTempSetType());
  ...
  assertEqual(TemperatureControl::instance()->tempSetTypeTypes::RAMP_TYPE, TemperatureControl::instance()->getTempSetType());
