...
const String DevID = "v172D35C152EDA6C";  // DeviceID from Pushingbox
...
const char APIServer[] = "api.pushingbox.com";  // pushingbox API server
...
int granularity;
int maxDataAge;
const float LeaseInterval = 4 * 86400000;  // Interval at which to renew DHCP lease (First number is days)
...
const String premidcalstring = "Cal,mid,";
const String prelowcalstring = "Cal,low,";
String midcalstring = "";
String lowcalstring = "";
String rightnow;
...
double frequency;
long onTime = 0;
const int recordLength = 70;   // length of each record to be logged
...
const char stdKeys[ROWS][COLS] = {{'1', '2', '3', 'A'}, {'4', '5', '6', 'B'}, {'7', '8', '9', 'C'}, {'*', '0', '#', 'D'}};
const byte rowPins[ROWS] = {34, 36, 38, 40};
const byte colPins[COLS] = {42, 44, 46, 48};
